...
label start:
    ...
    python:
        ...
        prolog = Prolog()
        prolog.consult('/home/edgardo/Documents/adriandetective.pl')
        asesino = list(prolog.query('murderer(X)'))
        e("The murder is %s"%asesino[0]['X'])
        new_prolog_code = open('/home/edgardo/Documents/murder.pl','w')
        new_facts = []
    menu:
        "Buy her an Iguana":
            python:
                new_facts.append('murderer(iguana).')
            $ gift = "iguana"
            e "I'll take an iguana, my good man!"
        "Buy her a Corn Snake":
            python:
                new_facts.append('murderer(cornsnake).')
            $ gift = "corn snake"
    ...
    python:
        ...
        prolog2 = Prolog()
        prolog2.consult('/home/edgardo/Documents/murder.pl')
